      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full py-20">
        <div className="max-w-3xl">
          ...
          <div className="flex flex-col sm:flex-row gap-6">
            ...
            <Button size="lg" variant="outline" className="h-20 px-10 rounded-full text-lg font-bold border-2 border-white/30 text-white hover:bg-white/10 backdrop-blur-md transition-all flex gap-3 uppercase tracking-widest">
